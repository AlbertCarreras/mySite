  ...
  render() {
    return (
      <div className='sub-container detail-container project-container'>
          ...
          <div>
            <div className='project-title'>IEX Trading App</div>
            <div className='project-links'>
              <a 
              className='links'
              href="https://github.com/AlbertCarreras/IEXapp/tree/master/iex_app_react"
              target="_blank"
              rel="noopener noreferrer"  
              >GITHUB Front-end</a> | 
              <a 
              className='links'
              href="https://github.com/AlbertCarreras/IEXapp/tree/master/iex_app_api"
              target="_blank"
              rel="noopener noreferrer"
              >GITHUB Back-end</a>
            </div>
            <div className='section'>A trade-wallet simulator app to search, buy, and sell stock shares using the Investors Exchange (IEX) API.</div>
            <div className='video-container'>

              <iframe 
                title='IEX' 
                src="https://www.youtube-nocookie.com/embed/qFopD7s0BEw" 
                frameborder="0" 
            ...
            <div>
              <div className='subtitle'>Front-end</div>
                <ul>
                  <li>React with Redux & Redux Thunk</li>
                  <li>D3 for chart visualization</li>
                </ul>
                <div className='subtitle'>Back-end</div>
                <ul>
                  <li>Rails API with with serialization and Postgres
